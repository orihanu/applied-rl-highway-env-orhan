...
def train_full_dqn(
    ...
    """
    Train a fully converged DQN agent on the Highway-Env environment.

    Evaluation is periodically performed using a separate environment,
    and the best-performing model is saved automatically.
    """
